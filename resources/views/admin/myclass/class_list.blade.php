                               ...
                               <div class="table-responsive">
                                   <table class="table table-bordered">
                                       ...
                                       @foreach($myclasses as $myclass)
                                           <tr style="">
                                               <td width="">{{$i++}}</td>
                                               <td width="">{{$myclass->myclass_name}}</td>
                                               <td width="">

                                                      <a style="width:60px;"  href="{{route('myclass.edit',$myclass->id)}}" class="btn btn-primary btn-sm">Edit</a>



                                                   <form class="mt-2" action="{{ route('myclass.destroy' , $myclass->id)}}" method="POST" class="form-inline">
